...
user_update = cUserViewSet.as_view({"patch":"update"})
...
district_delete = DistrictViewSet.as_view({"delete":"delete"})
...
policeStationContact_delete = PoliceStationContactViewSet.as_view({"delete":"delete"})
...
policeStation_delete = PoliceStationViewSet.as_view({"delete":"delete"})
...
policeOfficer_delete = PoliceOfficerViewSet.as_view({"delete":"delete"})
...
case_delete = CaseViewSet.as_view({"delete":"delete"})
...
caseHistory_delete = CaseHistoryViewSet.as_view({"delete":"delete"})
...
media_delete = MediaViewSet.as_view({"delete":"delete"})
...
lostVehicle_delete = LostVehicleViewSet.as_view({"delete":"delete"})
